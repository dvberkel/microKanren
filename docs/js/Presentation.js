...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bg: 'hidden', a2: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bg: 'mozHidden', a2: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bg: 'msHidden', a2: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bg: 'webkitHidden', a2: 'webkitvisibilitychange' }
		: { bg: 'hidden', a2: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bj, request.aa, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bc: fragment, az: host, aG: path, aI: port_, aL: protocol, aM: query};
	});
...
var $author$project$Presentation$Loading = {$: 1};
var $author$project$Presentation$Idle = {$: 0};
var $author$project$Presentation$createModel = F3(
	function (base, navigationKey, presentation) {
		return {U: base, M: navigationKey, q: presentation, Y: _List_Nil, _: $author$project$Presentation$Idle};
	});
...
var $author$project$Presentation$Kernel$emptyPresentation = {n: $author$project$Presentation$Kernel$Blank, r: _List_Nil, p: _List_Nil};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{a$: false, ar: r.ar, a7: r.a7, bf: r.bf, bj: r.bj, bJ: r.bJ, bL: r.bL, aa: r.aa}));
};
...
var $author$project$Presentation$init = F3(
	function (flags, origin, key) {
		var model = A2(
			...
			A3($author$project$Presentation$createModel, origin, key, $author$project$Presentation$Kernel$emptyPresentation));
		var command = $elm$http$Http$request(
			{
				ar: $elm$http$Http$emptyBody,
				a7: $elm$http$Http$expectString($author$project$Presentation$Got),
				bf: _List_fromArray(
					[
...
var $author$project$Presentation$onUrlChange = function (_v0) {
	return $author$project$Presentation$DoNothing;
};
var $author$project$Presentation$onUrlRequest = function (_v0) {
	return $author$project$Presentation$DoNothing;
};
...
var $author$project$Presentation$Parse = function (a) {
	return {$: 5, a: a};
};
var $author$project$Presentation$ParseFailure = function (a) {
	return {$: 4, a: a};
};
var $elm$url$Url$Builder$Relative = {$: 1};
var $author$project$Presentation$RequestFailure = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Presentation$Kernel$currentIndex = function (_v0) {
	var preceding = _v0.p;
...
var $dvberkel$microkanren$MicroKanren$Kernel$callFresh = function (f) {
	return function (state) {
		return A2(
			f,
			$dvberkel$microkanren$MicroKanren$Kernel$Variable(state.bd),
			_Utils_update(
				state,
				{bd: state.bd + 1}));
	};
...
var $dvberkel$microkanren$MicroKanren$Kernel$walk = F2(
	function (term, substitution) {
		...
		while (true) {
			if (!term.$) {
				var variable = term.a;
				var _v1 = A2($elm$core$Dict$get, variable, substitution);
				if (!_v1.$) {
					var value = _v1.a;
					var $temp$term = value,
...
var $dvberkel$microkanren$MicroKanren$Kernel$unify = F3(
	function (left, right, substitution) {
		...
		while (true) {
			...
			var _v0 = _Utils_Tuple2(leftWalk, rightWalk);
			_v0$3:
			while (true) {
				_v0$5:
				while (true) {
					switch (_v0.a.$) {
						...
						case 0:
							if (!_v0.b.$) {
								var leftVariable = _v0.a.a;
								var rightVariable = _v0.b.a;
						...
						default:
							switch (_v0.b.$) {
								...
								case 2:
									var _v1 = _v0.a.a;
									var leftFirst = _v1.a;
									var leftSecond = _v1.b;
									var _v2 = _v0.b.a;
									var rightFirst = _v2.a;
									var rightSecond = _v2.b;
									var _v3 = A3($dvberkel$microkanren$MicroKanren$Kernel$unify, leftFirst, rightFirst, substitution);
									if (!_v3.$) {
										var nextSubstitution = _v3.a;
...
var $dvberkel$microkanren$MicroKanren$Kernel$identical = F2(
	function (left, right) {
		return function (state) {
			var _v0 = A3($dvberkel$microkanren$MicroKanren$Kernel$unify, left, right, state.bG);
			if (!_v0.$) {
				var substitution = _v0.a;
	...
	A3(
		...
		A3(
			...
			A3(
				...
				$elm$core$Dict$empty))));
var $author$project$Presentation$Kernel$skipTo = F2(
	function (targetIndex, presentation) {
		skipTo:
		while (true) {
			var _v0 = A2(
			...
			switch (_v0) {
				case 0:
					var $temp$targetIndex = targetIndex,
						$temp$presentation = $author$project$Presentation$Kernel$advance(presentation);
					targetIndex = $temp$targetIndex;
					presentation = $temp$presentation;
					continue skipTo;
				case 1:
					return presentation;
				default:
					var $temp$targetIndex = targetIndex,
						$temp$presentation = $author$project$Presentation$Kernel$backtrack(presentation);
					targetIndex = $temp$targetIndex;
					presentation = $temp$presentation;
					continue skipTo;
			}
...
var $author$project$Presentation$Kernel$slideCount = function (_v0) {
	var preceding = _v0.p;
	var current = _v0.n;
	var following = _v0.r;
	return ($elm$core$List$length(preceding) + 1) + $elm$core$List$length(following);
};
var $author$project$Presentation$Kernel$jump = F2(
	function (index, presentation) {
		return ((1 <= index) && (_Utils_cmp(
			index,
			$author$project$Presentation$Kernel$slideCount(presentation)) < 1)) ? A2($author$project$Presentation$Kernel$skipTo, index, presentation) : presentation;
	});
...
var $dvberkel$microkanren$MicroKanren$Kernel$emptyState = {bd: 0, bG: $elm$core$Dict$empty};
var $dvberkel$microkanren$MicroKanren$streamModelFromGoal = F2(
	function (name, goal) {
		return {
			ag: name,
			P: _List_Nil,
			H: goal($dvberkel$microkanren$MicroKanren$Kernel$emptyState)
		};
	});
...
var $dvberkel$microkanren$MicroKanren$update = F2(
	function (_v0, model) {
		var stream = $dvberkel$microkanren$MicroKanren$UserLevel$pull(model.H);
		if (stream.$ === 2) {
			var state = stream.a;
			var followingStream = stream.b;
			return _Utils_update(
			...
			return _Utils_update(
				model,
				{H: $dvberkel$microkanren$MicroKanren$Kernel$Empty});
		}
	});
	...
	function (message, model) {
		switch (message.$) {
			case 4:
				...
				if (!result.$) {
					var source = result.a;
					var task = $elm$core$Task$succeed(source);
					var nextModel = A2($author$project$Presentation$updateStatus, $author$project$Presentation$RequestSuccess, model);
					return _Utils_Tuple2(
						nextModel,
						A2($elm$core$Task$perform, $author$project$Presentation$Parse, task));
				} else {
					var error = result.a;
					var nextModel = A2(
						$author$project$Presentation$updateStatus,
						$author$project$Presentation$RequestFailure(error),
						model);
					return _Utils_Tuple2(nextModel, $elm$core$Platform$Cmd$none);
				}
			case 5:
				var source = message.a;
				var _v2 = A2($author$project$Presentation$Parser$parse, $author$project$Presentation$Goals$goals, source);
				if (!_v2.$) {
					var presentation = _v2.a;
					var aPresentation = A2(
						$elm$core$Maybe$withDefault,
						presentation,
						A2(
							$elm$core$Maybe$map,
							function (targetIndex) {
								return A2($author$project$Presentation$Kernel$jump, targetIndex, presentation);
							},
							A2($elm$core$Maybe$andThen, $elm$core$String$toInt, model.U.bc)));
					var nextModel = A2(
						$author$project$Presentation$updateStatus,
						$author$project$Presentation$Idle,
						A3($author$project$Presentation$createModel, model.U, model.M, aPresentation));
					return _Utils_Tuple2(
						nextModel,
					...
					var nextModel = A2(
						$author$project$Presentation$updateStatus,
						$author$project$Presentation$ParseFailure(error),
						model);
					return _Utils_Tuple2(nextModel, $elm$core$Platform$Cmd$none);
				}
			case 0:
			...
			case 1:
				...
				var navigationCommand = A2($elm$browser$Browser$Navigation$pushUrl, model.M, url);
				return _Utils_Tuple2(
					nextModel,
			...
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(
							$author$project$Presentation$Kernel$slideCount(presentation)))
					]))
			]));
};
var $author$project$Presentation$Kernel$viewInfo = function (presentation) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Presentation$Kernel$viewCount(presentation)
			]));
};
...
var $author$project$Presentation$Kernel$toClassName = function (slide) {
	switch (slide.$) {
		case 0:
			return 'blank';
		case 1:
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(state.bd))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						model.P)),
					$dvberkel$microkanren$MicroKanren$viewStream(model.H)
				]));
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							$author$project$Presentation$Kernel$toClassName(slide),
							true)
						]))
				]),
			content);
...
var $author$project$Presentation$main = $elm$browser$Browser$application(
	{bi: $author$project$Presentation$init, bt: $author$project$Presentation$onUrlChange, bu: $author$project$Presentation$onUrlRequest, bF: $author$project$Presentation$subscriptions, bM: $author$project$Presentation$update, bN: $author$project$Presentation$view});
